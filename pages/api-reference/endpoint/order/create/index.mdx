---
title: Order Create
description: Create an order (sale, advance, credit)
openapi: 'POST /order/create'
---

## Overview

The **Order Create API** allows you to create a new order, including sales, advance payments, or credit orders.

This endpoint supports detailed product information, pricing, discounts, VAT, and optional payment extra info (for Payme, Click, Uzum, Anor).
