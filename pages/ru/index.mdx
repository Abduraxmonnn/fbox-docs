...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="terminal"
    href="/ru/api-reference/introduction"
  >
...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="recycle"
    href="/ru/essentials/reusable-snippets"
  >
