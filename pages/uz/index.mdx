...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="terminal"
    href="/uz/api-reference/introduction"
  >
...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="recycle"
    href="/uz/essentials/reusable-snippets"
  >
