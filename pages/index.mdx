...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="palette"
    href="pages/essentials/settings"
  >
    ...
    icon="map"
    href="pages/essentials/navigation"
  >
  ...
  <Card
    ...
    icon="terminal"
    href="pages/api-reference/introduction"
  >
...
<Columns cols={2}>
  <Card
    ...
    icon="pen-fancy"
    href="pages/essentials/markdown"
  >
  ...
  <Card
    ...
    icon="recycle"
    href="pages/essentials/reusable-snippets"
  >
